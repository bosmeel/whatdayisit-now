...
export const metadata: Metadata = {
  ...
  description:
    "Browse famous birthdays for every day of the year.",
  alternates: {
    canonical: "https://whatdayisit.now/famous-birthdays",
  },
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-5xl px-4 py-10">
      ...
      <p className="mb-10">
        Explore well-known people born on every day of the year.
      </p>

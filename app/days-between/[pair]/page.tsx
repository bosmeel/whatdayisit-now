...
export default async function DaysBetweenPairPage({ params }: Props) {
  ...
  return (
    <main style={{ maxWidth: 900, margin: "40px auto", padding: 20 }}>
      ...
      <p>
        This page calculates the number of days between <strong>{data.label}</strong>.
      </p>
      ...
      <p style={{ marginTop: 20 }}>
        <Link href="/days-between">← Back to days between calculator</Link>
      </p>
